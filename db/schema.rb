...
ActiveRecord::Schema[7.0].define(version: 2023_09_06_051523) do
  ...
  create_table "motors", force: :cascade do |t|
    ...
    t.bigint "type_of_equipment_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["type_of_equipment_id"], name: "index_motors_on_type_of_equipment_id"
  end

  create_table "type_of_equipments", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "type_of_maintenances", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "motors", "type_of_equipments"
end
